const LANG = {
    th: {
        ...
        major: "การจัดการเรียนการสอน วิชาเอก",
        dtmed: "✦แนวคิดนวัตกรรมทางการแพทย์",
        obsci: "✦สัมนาทางวิทยาศาสตร์",
        bsinno: "✦พื้นฐานนวัตกรรม",
        drone4: "หนูน้อยเจ้าเวหา 4",
        kmutl: "คณะวิศวกรรมเครื่องยนต์การบิน-อวกาศ สถาบันเทคโนโลยีอวกาศนานาชาติเพื่อการพัฒนาเศรษฐกิจ มจพ.",
        kuf: "คณะวิศวกรรมการบินและอวกาศ หลักสูตรiddp ม.เกษตร",
    ...
    en: {
        ...
        com: "Competition",
        posn: "POSN ",
        major: "Major Subject Instruction",
        detail: "Detail",
        ...
        kuf: "International Double Degree Program (IDDP) in Aerospace Engineering and Business Management",
        kmutl: "Bachelor of Engineering Program in Aerospace Propulsion Engineering",
